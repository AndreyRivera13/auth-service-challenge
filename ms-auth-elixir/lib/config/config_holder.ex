defmodule Authelixir.Config.ConfigHolder do
  use GenServer
  alias Authelixir.Config.AppConfig
  @table_name :authelixir_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:authelixir, :config_loaders, [])
...
defmodule Authelixir.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias Authelixir.Config.AppConfig
